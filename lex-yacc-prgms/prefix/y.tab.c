...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 20 "prefix.y" /* yacc.c:1646  */
    { printf("%s\n",(yyvsp[-1])); exit(1);}
#line 1208 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 23 "prefix.y" /* yacc.c:1646  */
    { strcpy(st,"+"); strcpy(s1,(yyvsp[-2])); strcpy(s2,(yyvsp[0])); strcat(s1,s2); strcat(st,s1); strcpy((yyval),st); }
#line 1214 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 24 "prefix.y" /* yacc.c:1646  */
    { strcpy(st,"-"); strcpy(s1,(yyvsp[-2])); strcpy(s2,(yyvsp[0])); strcat(s1,s2); strcat(st,s1); strcpy((yyval),st); }
#line 1220 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 25 "prefix.y" /* yacc.c:1646  */
    { strcpy(st,"*"); strcpy(s1,(yyvsp[-2])); strcpy(s2,(yyvsp[0])); strcat(s1,s2); strcat(st,s1); strcpy((yyval),st); }
#line 1226 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 26 "prefix.y" /* yacc.c:1646  */
    { strcpy(st,"/"); strcpy(s1,(yyvsp[-2])); strcpy(s2,(yyvsp[0])); strcat(s1,s2); strcat(st,s1); strcpy((yyval),st); }
#line 1232 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 27 "prefix.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[-1]);}
#line 1238 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 28 "prefix.y" /* yacc.c:1646  */
    {}
